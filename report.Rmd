...
The state regularly publishes the monthly cannabis sales [here](https://www.colorado.gov/pacific/revenue/colorado-marijuana-sales-reports) in each county, with only a few exceptions.
